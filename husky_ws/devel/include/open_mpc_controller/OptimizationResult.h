// Generated by gencpp from file open_mpc_controller/OptimizationResult.msg
// DO NOT EDIT!


#ifndef OPEN_MPC_CONTROLLER_MESSAGE_OPTIMIZATIONRESULT_H
#define OPEN_MPC_CONTROLLER_MESSAGE_OPTIMIZATIONRESULT_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::open_mpc_controller::OptimizationResult_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::open_mpc_controller::OptimizationResult_<ContainerAllocator> const> ConstPtr;

}; // struct OptimizationResult_

typedef ::open_mpc_controller::OptimizationResult_<std::allocator<void> > OptimizationResult;

typedef boost::shared_ptr< ::open_mpc_controller::OptimizationResult > OptimizationResultPtr;
typedef boost::shared_ptr< ::open_mpc_controller::OptimizationResult const> OptimizationResultConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::open_mpc_controller::OptimizationResult_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::open_mpc_controller::OptimizationResult_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::open_mpc_controller::OptimizationResult_<ContainerAllocator1> & lhs, const ::open_mpc_controller::OptimizationResult_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::open_mpc_controller::OptimizationResult_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::open_mpc_controller::OptimizationResult_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::open_mpc_controller::OptimizationResult_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::open_mpc_controller::OptimizationResult_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::open_mpc_controller::OptimizationResult_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::open_mpc_controller::OptimizationResult_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::open_mpc_controller::OptimizationResult_<ContainerAllocator> >
{
  ...
  static const char* value(const ::open_mpc_controller::OptimizationResult_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xaf1bd1e7f40ea424ULL;
  static const uint64_t static_value2 = 0x386b21d5312bdc7fULL;
};

template<class ContainerAllocator>
struct DataType< ::open_mpc_controller::OptimizationResult_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::open_mpc_controller::OptimizationResult_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::open_mpc_controller::OptimizationResult_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::open_mpc_controller::OptimizationResult_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::open_mpc_controller::OptimizationResult_<ContainerAllocator>& v)
  {
...
#endif // OPEN_MPC_CONTROLLER_MESSAGE_OPTIMIZATIONRESULT_H
